...
function PreOrderSection({ promoUnlocked = false }: { promoUnlocked?: boolean }) {
  ...
  return (
    <section id="preorder" className="px-5" style={{ paddingTop: "4rem", paddingBottom: "5rem", background: "#f7f4ef", position: "relative", zIndex: 2 }}>
      <div className="max-w-xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="text-center" style={{ marginBottom: "2.5rem" }}>
          <p style={{ fontSize: "0.75rem", fontWeight: 600, letterSpacing: "0.12em", color: "#8b5a3c", textTransform: "uppercase", marginBottom: "0.6rem" }}>Pesan Sekarang</p>
          <h2 style={{ fontSize: "clamp(1.75rem, 4vw, 3rem)", fontWeight: 800, color: "#1a1a1a", letterSpacing: "-0.02em" }}>Pre-Order Milkyu</h2>
          <p style={{ fontSize: "clamp(0.85rem, 2vw, 1rem)", color: "#888", marginTop: "0.75rem", lineHeight: 1.7 }}>
            Isi form di bawah, lalu klik tombol untuk langsung chat ke WhatsApp kami 🥛
          </p>
        </motion.div>

        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} viewport={{ once: true }}
          style={{ background: "#fff", borderRadius: "20px", padding: "clamp(1.25rem, 5vw, 2rem)", boxShadow: "0 4px 32px rgba(0,0,0,0.07)", border: "1px solid rgba(0,0,0,0.06)" }}
        >

          {/* Nama */}
          <div style={{ marginBottom: "1.25rem" }}>
            <label style={{ fontSize: "0.8rem", fontWeight: 700, color: "#555", letterSpacing: "0.05em", textTransform: "uppercase", display: "block", marginBottom: "0.5rem" }}>
              Nama Kamu *
            </label>
            <input
              type="text"
          ...
          <div style={{ marginBottom: "1.5rem" }}>
            ...
            <textarea
              rows={2}
              placeholder="Contoh: gulanya dikurangi ya kak 🙏"
              value={note}
          ...
          {selectedItems.length > 0 && (
            <div style={{ background: "rgba(139,90,60,0.06)", borderRadius: "10px", padding: "0.75rem 1rem", marginBottom: "1.25rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <span style={{ fontSize: "0.85rem", color: "#8b5a3c", fontWeight: 600 }}>Total Pesanan</span>
              <span style={{ fontSize: "1rem", color: "#1a1a1a", fontWeight: 800 }}>{formatRp(total)}</span>
            </div>
          )}

          {/* Tombol Checkout */}
          <CheckoutButton
            order={{ buyerName: name, items: selectedItems, note: note || undefined }}
  ...
  return (
    <div className="min-h-screen" style={{ background: "#f7f4ef", position: "relative", overflow: "hidden" }}>
      ...
      <motion.header
        ...
        style={{ background: "#e8e2d9", backdropFilter: "blur(12px)", borderBottom: "1px solid rgba(0,0,0,0.06)" }}
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between" style={{ padding: "0.75rem 1.25rem" }}>
          <div className="flex items-center gap-3">
            <img src="images/milkyu-logo.png" alt="Milkyu Logo" style={{ width: 36, height: 36, objectFit: "contain" }} />
          ...
          <nav className="nav-desktop items-center gap-8" style={{ fontSize: "0.9rem", color: "#666", fontWeight: 500 }}>
            <a href="#flavors"      style={{ textDecoration: "none", color: "#666" }} className="hover:opacity-60 transition-opacity">Menu Utama</a>
            <a href="#cookie"       style={{ textDecoration: "none", color: "#666" }} className="hover:opacity-60 transition-opacity">Menu Sampingan</a>
            <a href="#preorder"     style={{ textDecoration: "none", color: "#666" }} className="hover:opacity-60 transition-opacity">Pre-Order</a>
      ...
      >
        <div className="max-w-4xl mx-auto text-center w-full" style={{ position: "relative", zIndex: 2, paddingTop: "5rem" }}>
          ...
          >
            ...
            <img src="images/milkyu-logo.png" alt="Milkyu Logo" className="hero-logo-img" style={{ objectFit: "contain", position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)" }} />
          </motion.div>
      ...
      <section id="flavors" className="px-5" style={{ paddingTop: "4rem", paddingBottom: "5rem", position: "relative", zIndex: 2 }}>
        <div className="max-w-6xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="text-center" style={{ marginBottom: "2.5rem" }}>
            <p style={{ fontSize: "0.75rem", fontWeight: 600, letterSpacing: "0.12em", color: "#8b5a3c", textTransform: "uppercase", marginBottom: "0.6rem" }}>Menu Utama</p>
      ...
      {/* ── COOKIE ── */}
      <section id="cookie" className="px-5" style={{ paddingTop: "4rem", paddingBottom: "5rem", background: "#e8e2d9", position: "relative", zIndex: 2 }}>
        <div className="max-w-6xl mx-auto">
          <motion.div
      ...
      <footer className="py-8 px-5 text-center" style={{ background: "#111111" }}>
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-center gap-3 mb-4">
            <img src="images/milkyu-logo.png" alt="Milkyu Logo" style={{ width: 26, height: 26, objectFit: "contain", filter: "brightness(0) invert(1)", opacity: 0.7 }} />
