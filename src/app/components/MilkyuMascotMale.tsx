...
export function MilkyuMascotMale() {
  ...
  return (
    <>
      <style>{`
        ...
        .milkyu-arm-wave-male {
          transform-origin: 104px 105px;
          animation: ${waving ? "milkyu-wave 0.95s ease-in-out" : "none"};
        }
        .milkyu-tail-male { transform-origin: 90px 118px; animation: milkyu-tail 2s ease-in-out infinite; }
      ...
      {/* ── MASCOT (male — no blush, no eyelashes) ── */}
      <div
        ref={mascotRef}
        onClick={handleClick}
        style={{
      ...
      >
        <div className="milkyu-bounce" style={{ width: "100%", height: "100%" }}>
          <svg width="100%" height="100%" viewBox="0 0 130 170" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g className="milkyu-arm-wave-male">
